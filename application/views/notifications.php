       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">Notification</h2>             
            </div>
          </div>
       </div>
      <div class="container">
					...
					<?php foreach($notification as $key => $val){?>
						<div class="row  margin-top border-bottom">
							<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 fadeInDown wow animated" style="visibility: visible;">
								...
								<?php echo $val['notification_title'];?></div>
								...
								<div style="float:right;width:40%;border-top:none;margin-top:0px;line-height:50px;">
									<a href="<?php echo IMAGE_PATHBK.$val['notification'];?>" target="_blank" style="color: #15adcc;">Read More &gt;</a>
								</div>
							</div>
						</div><hr>
					<?php }?>
