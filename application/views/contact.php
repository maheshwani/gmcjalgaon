			...
			<div class="box">							
				<div class="icon">
					...
					<div class="info">
						...
						<p>
							<i class="fa fa-envelope" aria-hidden="true"></i> &nbsp deangmcjalgaon@gmail.com																			
						</p>
			...
			<div class="box">							
				<div class="icon">
					...
					<div class="info">
    					...
    					<p>
							<i class="fa fa-phone" aria-hidden="true"></i> &nbsp (0257) 2232390					
						</p>
					</div>
				</div>
				<div class="space"></div>
			...
			<div class="box">							
				<div class="icon">
					...
					<div class="info">
    					...
    					<p>
							 <i class="fa fa-map-marker" aria-hidden="true"></i> &nbsp Govt. Medical College, Civil Hospital Campus,
									Jalgaon,(M.H)
						</p>
					</div>
				</div>
