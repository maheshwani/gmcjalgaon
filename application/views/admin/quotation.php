...
<div  class="container">
  <div class="row well">
    ...
    <span class="add">Add Quotation</span>
     <?php 
	...
	<div class="col-md-12 col">      
        <div class="form-group">
          ...
          <div class="col-md-6">
    		    <input type="text" class="form-control" id="quotation_title" name="quotation_title" aria-describedby="fileHelp" required>
          </div>                    
        </div>
      </div>
        ...
        <div class="col-md-12 well">
          ...
          <div class="login-pop">           
            ...
            <table class="table table-bordered" id="example" style="margin-left: -28px;">
              ...
              <tbody>
				<?php foreach($quotation_list as $key => $val){?>
					<tr>
						<td>
							<?php echo $val['quotation_title']; ?>							
						</td>
                    ...
                    <?php }else{ ?>
                      <img src="<?= $this->config->item('cdn'); ?>img/delete.jpg" class="status" style="height: 20px;"/> 
						...
						<td style="text-align:center" width="200px">                                            
							<a id="delete" href="<?php echo site_url('Login_success/delete/?id='.$val['id'].'/quotation');?>"><i class="glyphicon del glyphicon-trash" aria-hidden="true"></i></a>
						</td>
					</tr>
              <?php }?>
              </tbody>
